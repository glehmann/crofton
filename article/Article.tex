...
The (planar) circularity (often called "shape factor") is defined as:
\begin{eqnarray}
f = 4\pi \frac{A}{p^2}
\end{eqnarray}

Circularity takes values between $0$ and $1$. It is equal to $1$ for circular shapes, and decreases for elongated shapes.

[on garde la circularité ?]
...
% \begin{figure}[!htb]
% \begin{center}
% \includegraphics[width=5cm]{discreteDisk.eps}
% %\includegraphics[width=5cm][bb=0 0 605 605]{chick.png}
% \end{center}
% \end{figure}
