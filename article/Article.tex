...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=10cm]{images/discreteDisks2}
\end{center}
...
Figure \ref{fig:MeasureSquareOriented} shows measures obtained on discretized ellipses 
...
Timing results for measuring the surface area of a ball with radius 450 voxels in a 
